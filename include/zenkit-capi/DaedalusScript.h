...
ZKC_API void ZkDaedalusSymbol_setLocalVariablesEnabled(ZkDaedalusSymbol* slf, ZkBool enable);
ZKC_API ZkBool ZkDaedalusSymbol_getLocalVariablesEnabled(ZkDaedalusSymbol const* slf);
